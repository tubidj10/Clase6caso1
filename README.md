# Asistente de reposición de inventario

## Qué construí
Consulta existencias y demanda, calcula cantidades por bulto y propone reposición. No emite órdenes de compra.
...
La demanda diaria es un dato de entrada, no un pronóstico validado. No se consideran mínimos de proveedor, caducidad ni presupuesto de compras. Los datos de ejemplo son sintéticos; no se acredita una integración con ERP ni un uso empresarial.
